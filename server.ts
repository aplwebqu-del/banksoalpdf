...
// ==============================================================================
app.get('/api/google/storages', (req: Request, res: Response) => {
...
app.get('/api/google/storages/active', (req: Request, res: Response) => {
  const storageManager = GoogleStorageManagerService.getInstance();
  res.json({ profile: storageManager.getActiveProfile() });
});

app.post('/api/google/storages', (req: Request, res: Response) => {
  try {
    const storageManager = GoogleStorageManagerService.getInstance();
...
app.put('/api/google/storages/:id', (req: Request, res: Response) => {
  try {
    const storageManager = GoogleStorageManagerService.getInstance();
...
app.delete('/api/google/storages/:id', (req: Request, res: Response) => {
  try {
    const storageManager = GoogleStorageManagerService.getInstance();
...
app.post('/api/google/storages/:id/activate', (req: Request, res: Response) => {
  try {
    const storageManager = GoogleStorageManagerService.getInstance();
...
app.post('/api/google/storages/:id/test', async (req: Request, res: Response) => {
  try {
    const storageManager = GoogleStorageManagerService.getInstance();
