...
export type StorageProfileStatus = 'ACTIVE' | 'INACTIVE' | 'connected' | 'disconnected' | 'error' | 'untested';
export type ConnectionStatusType = 'CONNECTED' | 'ERROR' | 'TIMEOUT' | 'UNAUTHORIZED' | 'NOT_CONFIGURED' | 'PENDING';
